...
mvn quarkus:dev                         // check 2.2.2.Final quarkus pom version
./mvnw compile quarkus:dev              // to run programm
// to run quarkus server. running in :dev environments enables hot swap
